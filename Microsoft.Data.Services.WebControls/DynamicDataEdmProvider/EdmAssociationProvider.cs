...
namespace Microsoft.Data.Services.DynamicDataEdmProvider {
    internal sealed class EdmAssociationProvider : AssociationProvider {
        public EdmAssociationProvider(EdmColumnProvider column, NavigationProperty navigationProperty) {
            FromColumn = column;

            var entityMemberParentEntity = (EdmTableProvider)column.Table;
            var parentEntityModel = (EdmDataModelProvider)entityMemberParentEntity.DataModel;

            EdmColumnProvider columnProvider;
